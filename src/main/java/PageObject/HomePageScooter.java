...
public class HomePageScooter {
    ...
    private final By stepOneToOrderTheScooter = By.xpath(".//div[@class = 'Home_Status__YkfmH' and text()='Заказываете самокат']");
    //            [ ]  Описание Шага 1 "Выбираете, когда и куда привезти". !!!
    //            При попытке поставить локатор с поиском по классу и текстом - локатор не будет находиться, а если искать просто по классу, то найдет 4 варианта. Это единственный способ что я нашел.
    ...
    private final By stepTwoToOrderTheScooter = By.xpath(".//div[@class = 'Home_Status__YkfmH' and text()='Курьер привозит самокат']");
    //            [ ]  Описание Шага 2 "А вы — оплачиваете аренду"
    private final By additionalDiscriptionOfTheSecondStep = By.xpath(".//div[@class = 'Home_StatusDescription__3WGl5' and text()='А вы — оплачиваете аренду']");
    //            [ ]  Шаг 3 "Катаетесь".
    private final By stepThreeToOrderTheScooter = By.xpath(".//div[@class = 'Home_Status__YkfmH' and text()='Катаетесь']");
    //            [ ]  Описание Шага 3 "Сколько часов аренды осталось — видно на сайте"
    private final By additionalDiscriptionOfTheThirdStep = By.xpath(".//div[@class = 'Home_StatusDescription__3WGl5' and text()='Сколько часов аренды осталось — видно на сайте']");
    //            [ ]  Шаг 4 "Курьер забирает самокат".
    private final By stepFourToOrderTheScooter = By.xpath(".//div[@class = 'Home_Status__YkfmH' and text()='Курьер забирает самокат']");
    //            [ ]  Описание Шага 4 "Когда аренда заканчивается".
    private final By additionalDiscriptionOfFourthStep = By.xpath(".//div[@class = 'Home_StatusDescription__3WGl5' and text()='Когда аренда заканчивается']");
